...
from ..model.events import SELECTION_CHANGED, FILTER_CHANGED, PARAMETER_CHANGED
...
class LogConsole(LogConsoleTemplate):
    def __init__(self, **properties):
        ...
        print(f"Registering logger with event handlers: {event_types}. Printing to console: {self.log_to_console}")
